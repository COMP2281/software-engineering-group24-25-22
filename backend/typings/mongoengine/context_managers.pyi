...
class MyThreadLocals(threading.local):
    no_dereferencing_class: Incomplete
...
def no_dereference(cls) -> Generator[None]: ...
...
def set_write_concern(collection, write_concerns) -> Generator[Incomplete]: ...
def set_read_write_concern(collection, write_concerns, read_concerns) -> Generator[Incomplete]: ...
