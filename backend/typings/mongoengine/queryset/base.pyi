...
class BaseQuerySet:
    ...
    def search_text(self, text, language: Incomplete | None = None, text_score: bool = True): ...
    ...
    def update(self, upsert: bool = False, multi: bool = True, write_concern: Incomplete | None = None, read_concern: Incomplete | None = None, full_result: bool = False, array_filters: Incomplete | None = None, **update): ...
    def upsert_one(self, write_concern: Incomplete | None = None, read_concern: Incomplete | None = None, **update): ...
    def update_one(self, upsert: bool = False, write_concern: Incomplete | None = None, full_result: bool = False, array_filters: Incomplete | None = None, **update): ...
    def modify(self, upsert: bool = False, full_response: bool = False, remove: bool = False, new: bool = False, array_filters: Incomplete | None = None, **update): ...
    ...
    def all_fields(self): ...
    def order_by(self, *keys, __raw__: Incomplete | None = None): ...
    ...
    def map_reduce(self, map_f, reduce_f, output, finalize_f: Incomplete | None = None, limit: Incomplete | None = None, scope: Incomplete | None = None) -> Generator[Incomplete]: ...
